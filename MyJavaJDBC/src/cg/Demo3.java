...
public class Demo3 {
	...
	public static void main(String[] args) throws SQLException{
		...
		ResultSet re=st.executeQuery("select aid,mobileno,accountholder,balance from account");
		re.afterLast();
		...
		if(a_id==101)
		{
			re.updateString("accountholder", "Raja sharma");
			re.updateDouble(4, 70000);
			re.updateRow();
		}
		...
		int r=st.executeUpdate("update account set accountholder='Ravi Sharma' where aid=101");
		...
		//r=st.executeUpdate("delete from account where aid=104");
